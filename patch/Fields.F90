...
Module Fields
    ...
    Integer :: vr, dvrdr, d2vrdr2, dvrdt, dvrdp, hvr, d2vrdrdt
    Integer :: vtheta, dvtdr, d2vtdr2, dvtdt, dvtdp, hvtheta, d2vtdrdt, d2vtdtdt
    Integer :: vphi, dvpdr, d2vpdr2, dvpdt, dvpdp, hvphi, d2vpdrdp, d2vpdtdp
    ...
    Integer, parameter :: teq = 4,  rhoeq = 5

    Integer, parameter :: weq = 1, peq =2, zeq = 3, aeq=4, ceq = 5
