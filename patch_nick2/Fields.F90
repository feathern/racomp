...
Module Fields
    ...
    !/////////////////////////////////////////////////////////////////////////////////////
    !  COMPRESSIBLE MODIFICATION:  ONLY THESE VARIABLES WILL ACTUALLY BE USED
    !  Other variables are retained so the code can compile without error
    !  New variables locations in global field  meta data buffer for compressible version
    Integer :: vr, dvrdr, d2vrdr2, dvrdt, dvrdp, hvr, d2vrdrdt, d2vrdrdp
    Integer :: vtheta, dvtdr, d2vtdr2, dvtdt, dvtdp, hvtheta, d2vtdrdt, d2vtdt2, d2vtdtdp
    Integer :: vphi, dvpdr, d2vpdr2, dvpdt, dvpdp, hvphi, d2vpdrdp, d2vpdtdp, d2vpdp2
    Integer :: tvar, dtdr, d2tdr2, dtdt, dtdp, htvar
    Integer :: rhovar, drhodr, d2rhodr2, drhodt, drhodp, hrhovar
    !==============================================================================
    !        Integer parameters used to reference specific equations and variables
    !                FOR LINEAR Solve
    !==============================================================================
    Integer, parameter :: vreq = 1,  vteq = 2,  vpeq = 3
    Integer, parameter :: teq = 4,  rhoeq = 5, ceq = 6,  aeq = 7
...
Contains
    ...
    Subroutine Initialize_Field_Structure()
        ...
        !//////////////////////////////////////////////////////////
        !   Throughout the forward loop, some variables are replaced
        ...
        if (.not. magnetism) then
            wsfcount(1,2) = 5        ! four RHS's go back for the solve
            wsfcount(2,2) = 5
            wsfcount(3,2) = 5
        else
            emfr     = avar
