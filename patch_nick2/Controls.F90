...
Module Controls
    ...
    Logical :: Coriolis = .true.
    Logical :: Centrifugal = .true.
    ...
    Real*8  :: pulse_freq = 3.14d0                     ! Nick says to set to zero.
    Real*8  :: pulse_sharpness = 0.01d0                ! Small values give square
    ...
    Namelist /Physical_Controls_Namelist/ magnetism, nonlinear, rotation, lorentz_forces, &
                ...
                & momentum_advection, inertia, coriolis, centrifugal, &
                & pulse_freq, pulse_sharpness
