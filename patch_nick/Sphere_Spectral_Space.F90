...
Contains
    ...
    Subroutine Post_Solve()
        ...
        ! COMPRESSIBLE NOTE:
        ! I don't believe we can diffuse implicitly now, due to the rho dependence.
        ! I will comment out the relevant and possibly useful code below..
        ...
        ! Compute the 1st and second radial derivatives
        ! W..
        ...
        Call gridcp%d_by_dr_cp(  tvar,   dvtdr, wsp%p1a, 1)
        ...
        ! COMPRESSIBLE COMMENTED OUT:  Call ctemp%construct('p1b')
        ...
        !/////////////////////////////////////////////////////////////////
        ! Compressible modification - commented out code elow.
        !  No need to add derivatives to p1b
        !  Old comment -->  The rest of the code can remain unchanged
        !/////////////////////////////////////////////////////////////////
